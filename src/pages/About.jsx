                ...
                <Box sx={{maxWidth:"250px",padding:"20px"}}>
                    ...
                    <Box sx={{maxWidth:'700px',padding:'10px'}} >
                        <Box sx={{display:'flex',justifyContent:'space-around',gap:'10px'}}>
                          <Card sx={{ maxWidth: '150px',textAlign:'center' }}>
                            <CardActionArea>
                              <CardContent>
                              <VerifiedIcon/>
