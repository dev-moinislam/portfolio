...
const education = [
    ...
    {
        label: 'Departmental Technology Courses:',
        description: 'understanding of GIS & Remote Sensing',
    },
    {
        label: 'Programming Language:',
        description: 'Good understanding of JavaScript & Basic understing of Python',
    },
    {
        label: 'Undergraduate Student:',
        description: '6th semester is running',
    },
    {
                ...
                <Box sx={{ maxWidth: 1000, pb: 15,ml:{xs:4,sm:0,md:8}, mt: 5, display: 'flex', gap: 7, flexWrap: 'wrap', justifyContent: { xs: 'center' } }}>
                    {activeSection === 'education' && (
                        <Stepper orientation="vertical" activeStep={-1}>
                            {education.map((step) => (
                                <Step key={step.label}>
                                    <StepLabel sx={{ width: '450px',maxWidth:'350px' }}>
